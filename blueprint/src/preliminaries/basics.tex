...
\begin{definition}[Algebra]
    ...
    \item there exists a \vocab{ring homomorphism} from $R$ to $A$, denoted $f : R \to_{+*} A$.
    ...
    where we omitted that the ring homomorphism $f$ is applied to $r$ before multiplication,
