...
\begin{definition}[Free algebra]
    ...
    An \vocab{free $R$-algebra} $A$ on $X$ (or "generated by $X$ ") is the \vocab{ring quotient} of the following inductively constructed set $A_{pre}$
...
\begin{definition}[Quotient of non-commutative ring]
    ...
    The \vocab{ring quotient} of $R$ by $r$
...
\begin{definition}[Tensor algebra relation]
    ...
    The \vocab{tensor algebra relation} on $M$ is the equivalence relation satisfying:
...
\begin{definition}[Tensor algebra]
    ...
    % \leanok
    \lean{TensorAlgebra}
    \uses{TensorAlgebra_Rel, RingQuot}

    Let $M$ be a module over $R$.

    An \vocab{tensor algebra} over $M$ (or "of $M$ ") $T$ is the \vocab{ring quotient} of the \vocab{free $R$-algebra} generated by $M$, 
    by the \vocab{tensor algebra relation} on $M$ \ref{TensorAlgebra_Rel}.
