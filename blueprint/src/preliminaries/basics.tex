...
\begin{definition}[Algebra]
    ...
    An \vocab{algebra} $A$ over $R$ is a pair $(M, *)$, satisfying:

    \begin{enumerate}
    \item The elements of $A$ form a \vocab{module} $M$ over $R$ under $+$ and $\bu$.

    \item The elements of $A$ form a \vocab{ring} under $*$.
